...
export const appointments: Appointment[] = [
  ...
  slot("apt-6", "2024-05-22", "10:00", 60, "cus-2", "Pedro Alves", "svc-1", "Aula de Tênis", "CONFIRMADO"),
  // Quinta 23
  slot("apt-7", "2024-05-23", "14:00", 60, "cus-7", "Fernanda Souza", "svc-2", "Personal", "AGUARDANDO"),
  // Sexta 24
  slot("apt-8", "2024-05-24", "15:00", 60, "cus-5", "Rafael Lima", "svc-1", "Aula de Tênis", "CONFIRMADO"),
  // Sábado 25
  slot("apt-9", "2024-05-25", "08:00", 60, "cus-5", "Bruno Lima", "svc-1", "Aula de Tênis", "CONFIRMADO"),
  slot("apt-10", "2024-05-25", "16:00", 50, "cus-6", "Camila Rocha", "svc-3", "Fisioterapia", "AGUARDANDO"),
]
...
export const todayAppointments: Appointment[] = [
  ...
  slot("today-4", "2024-05-22", "11:00", 60, "cus-5", "Bruno Lima", "svc-1", "Aula de Tênis", "CONFIRMADO"),
