...
export function FlouaIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* Linha superior do F */}
      <path
        d="M14 14 Q10 16 10 20 Q10 24 16 24 L32 24 Q38 24 38 28 Q38 32 32 34"
        stroke="url(#floua-grad)"
        strokeWidth="4"
        strokeLinecap="round"
        fill="none"
      />
      {/* Linha do meio do F */}
      <path
        d="M16 24 Q12 25 12 29 Q12 33 18 33 L28 33"
        stroke="url(#floua-grad)"
        strokeWidth="3.5"
        strokeLinecap="round"
        fill="none"
...
/** Mantém retrocompatibilidade com componentes que usam LogoMark */
    ...
    <div className={cn("flex flex-col items-center gap-2", className)}>
      ...
      {showTagline ? (
        <p className="text-xs text-muted-foreground">
          Menos tempo organizando. Mais tempo atendendo.
        </p>
      ) : null}
    </div>
  )
